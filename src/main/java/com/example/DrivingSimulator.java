...
public class DrivingSimulator {
    ...
    public static void changeGear() {
        ...
        switch (gearChoice) {
            case "P":
                gear = "P";
                speed = 0;
                System.out.println("Gear changed to Park.");
                break;
            case "D":
                gear = "D";
            ...
            case "R":
                ...
                break;
            default:
                System.out.println("Invalid gear choice. Please try again.");
        }
    ...
    public static void accelerate() {
        ...
        if (isEngineOn && !gear.equals("P")) {
            ...
            System.out.println("Cannot accelerate. Make sure the engine is on and the car is not in Park.");
        }
    ...
    public static void brake() {
        ...
        if (isEngineOn && speed > 5) {
            ...
            System.out.println("Cannot brake. Make sure the engine is on and the speed is greater than 5 km/h.");
        }
    }
